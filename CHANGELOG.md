...
## UNRELEASED ~~V1.2.12 (2025-06-DD)~~ 修復顯示錯誤與優化圖表樣式
### 新增功能 Added
...
- 顯示折線圖的時候，現在會在每個數值點的右上方顯示其對應的數值內容，更為方便查看存取
- 顯示長條圖的時候，現在會一併顯示背景格線，讓金額對照更容易
- 顯示長條圖的時候，現在會依照順序輪換顏色，更容易找到對應類別
- 顯示長條圖的時候，現在會在每個長條的上方顯示其對應的數值內容，更為方便查看存取
