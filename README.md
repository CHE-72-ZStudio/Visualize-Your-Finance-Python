...
|-------------|-----------------------------------------------------|-------------------|------------|---------------|
| ***1.4.1*** | 將 金額折線走勢圖／次數折線走勢圖 合併為同一張圖表，減少選單選項數量                 | 功能規劃 (Planning)   | 中 (Medium) | ***2026-??*** |
| ***1.4.1*** | 更新與修正 `README.md`、`USER.md` 與 `DEVELOPER.md` 檔案中的描述 | 功能規劃 (Planning)   | 低 (Low)    | ***2026-??*** |
| 1.5.0       | 增加可以寫入 `VYFP_Diag.log` 診斷日誌檔案的功能                    | 功能規劃 (Planning)   | 中 (Medium) | 2026-??       |
| 1.5.1       | 增加更多例外情形處理                                          | 正在討論 (Discussing) | 低 (Low)    | 2026-??       |
| 1.5.2       | 可執行檔集成華為 HarmonyOS Sans 字體                          | 正在討論 (Discussing) | 低 (Low)    | 2026-??       |
| 1.5.5       | 提升跨系統顯示相容性，並開始發行 macOS/Linux 可執行檔                   | 功能規劃 (Planning)   | 低 (Low)    | 2027-??       |
| 1.6.0       | 調整優化程式邏輯與簡化選單操作介面，降低運行時間並提升易用性，為即將新增的 GUI 功能做準備     | 功能規劃 (Planning)   | 低 (Low)    | 2027-??       |
| ***2.1.0*** | 增加多幣種的儲存、分析、顯示，增進使用者體驗                              | 功能規劃 (Planning)   | 中 (Medium) | ***2027-??*** |
| ***2.1.0*** | 增加跨系統平臺的通用 GUI，增進使用者體驗                              | 功能規劃 (Planning)   | 中 (Medium) | ***2027-??*** |
