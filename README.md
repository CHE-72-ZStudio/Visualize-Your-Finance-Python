...
|-------------|-----------------------------------------------------|-------------------|------------|---------------|
| ***1.4.1*** | 將 金額折線走勢圖／次數折線走勢圖 合併為同一張圖表，減少選單選項數量                 | 功能規劃 (Planning)   | 中 (Medium) | ***2025-??*** |
| ***1.4.1*** | 更新與修正 `README.md`、`USER.md` 與 `DEVELOPER.md` 檔案中的描述 | 功能規劃 (Planning)   | 低 (Low)    | ***2025-??*** |
| 1.5.0       | 增加可以寫入 `VYFP_Diag.log` 診斷日誌檔案的功能                    | 功能規劃 (Planning)   | 中 (Medium) | 2025-??       |
