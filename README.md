...
|-------------|--------------------------------------------|-------------------|------------|---------------|
| ***1.2.9*** | 在 `Func.py` 的 `analyze()` 中新增顯示特定期間的金額總和功能 | 準備發布 (Completed)  | 高 (High)   | ***2025-06*** |
| 1.3.0       | 增加可以寫入 `Diagnose.Log` 日誌檔案的功能              | 功能規劃 (Planning)   | 中 (Medium) | 2025-08       |
| 1.3.1       | 增加更多例外情形處理                                 | 正在討論 (Discussing) | 低 (Low)    | 2025-08       |
| 1.3.2       | 可執行檔集成華為 HarmonyOS Sans 字體                 | 正在討論 (Discussing) | 低 (Low)    | 2025-??       |
| 1.3.5       | 提升跨系統顯示相容性，並開始發行 macOS/Linux 可執行檔          | 功能規劃 (Planning)   | 低 (Low)    | 2026-??       |
