...
|-------------|-----------------------------------------------------|-------------------|------------|---------------|
| ***1.4.1*** | 將 金額折線走勢圖／次數折線走勢圖 合併為同一張圖表，減少選單選項數量                 | 功能規劃 (Planning)   | 中 (Medium) | ***2026-02*** |
| ***1.4.1*** | 更新與修正 `README.md`、`USER.md` 與 `DEVELOPER.md` 檔案中的描述 | 功能規劃 (Planning)   | 低 (Low)    | ***2026-02*** |
...
| ***2.0.0*** | 增加跨系統平臺的通用 GUI，增進使用者體驗                              | 功能規劃 (Planning)   | 中 (Medium) | ***2027-??*** |
